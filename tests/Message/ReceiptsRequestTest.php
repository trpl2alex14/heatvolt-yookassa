...
class ReceiptsRequestTest extends AbstractRequestTest
{
    ...
    public function testGetData($provider)
    {
        ...
        $this->assertEquals("2018-07-18T10:51:18.139+00:00", $data['created_at_gte']);
        $this->assertEquals("2018-07-18T10:51:18.139+00:00", $data['created_at_lte']);
        ...
        $this->request->setCreatedAt(new DateTime("2018-07-18T10:51:18.139+00:00"), ">");
        $data = $this->request->getData();
        $this->assertEquals("2018-07-18T10:51:18.139+00:00", $data['created_at_gt']);

        $this->request->setCreatedAt(new DateTime("2018-07-18T10:51:18.139+00:00"), "<");
        $data = $this->request->getData();
        $this->assertEquals("2018-07-18T10:51:18.139+00:00", $data['created_at_lt']);
